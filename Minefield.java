...
public class Minefield {
    ...
    private String getCellRepresentation(int x, int y) {
        ...
        switch (status) {
            case "M":
                return ANSI_RED + status + ANSI_GREY_BACKGROUND; // Mine cell
            case "F":
                return ANSI_PURPLE + status + ANSI_GREY_BACKGROUND; // Flagged cell
            case "0":
                return ANSI_BLUE + status + ANSI_GREY_BACKGROUND; // Zero cell
            default:
                return ANSI_CYAN + status + ANSI_GREY_BACKGROUND; // Other numbers
        }
    }
}
